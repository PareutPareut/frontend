...
>2. [ middlewares-라우트 핸들러](https://space-rumi.tistory.com/159) **<-타입스크립트**   TypeScript 경고: Response.json()이 유효하지만 네이티브 TypeScript 유형은 현재 오류를 표시하고, 대신 입력된 응답에 NextResponse.json()을 사용할 수 있습니다.
